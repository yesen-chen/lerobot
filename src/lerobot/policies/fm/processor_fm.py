...
"""Pre- and post-processor pipelines for FlowMatchingPolicy.

Same pattern as Diffusion Policy processors.
"""
...
def make_flow_matching_pre_post_processors(
    ...
    """Constructs pre-processor and post-processor pipelines for FlowMatchingPolicy.
